...
## 💸 Transaction – Input Adapter (Rest)
...
## 💸 Transaction – Output Adapter - Entity
...
## 💸 Transaction – Output Adapter - Repository
...
## 💸 Transaction – Output Adapter - Mapper
...
## 💸 Transaction – Output Adapter - TransactionJpaAdapter
...
`GlobalExceptionHandler` — centraliza todo el manejo de errores del sistema en un solo lugar.
Vive en `shared` porque es transversal a las 3 features. Cada tipo de excepción tiene su HTTP status correcto
y el formato de respuesta es consistente en toda la API (`ErrorResponse`).
