...
- `Generación de identificador externo` → el helper se encarga de crear el valor para `accountNumber` con formato
  estándar: `BNK-YYYYXXXXXXXXXX`.
- `Responsabilidad de la aplicación` → la generación de este código vive en la capa de aplicación,
  no en el dominio ni en infraestructura.
